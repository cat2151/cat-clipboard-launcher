...
from src.display import colorize_matched_text, display_tui, get_display_lines, get_matched_line_numbers
...
class TestExecuteCommand:
    ...
    @patch("src.command.subprocess.run")
